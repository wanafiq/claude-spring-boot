...
Use this reference for testing **REST API endpoints** that return JSON responses.
For testing **view-rendering controllers** (Thymeleaf), see [spring-boot-webapp-testing-with-mockmvctester.md](spring-boot-webapp-testing-with-mockmvctester.md).
...
public class TestcontainersConfig {
    ...
    static GenericContainer<?> mailpit = new GenericContainer<>("axllent/mailpit:latest").withExposedPorts(1025);
...
```java
package com.companyname.appname.users.rest;

import static org.assertj.core.api.Assertions.assertThat;

import com.companyname.appname.BaseIT;
import com.companyname.appname.users.rest.dto.RegisterUserResponse;
import org.junit.jupiter.api.Test;
import org.junit.jupiter.params.ParameterizedTest;
import org.junit.jupiter.params.provider.CsvSource;
import org.springframework.http.MediaType;
import org.springframework.test.web.client.ExchangeResult;
